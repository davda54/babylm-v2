...
def parse_arguments():
    ...
    parser.add_argument("--name", default="base_attention_glu", type=str, help="Name of the run.")
    parser.add_argument("--config_file", default="/pfs/lustrep1/scratch/project_465000144/dasamuel/babylm-v2/configs/base_attentionglu.json", type=str, help="The BERT model config")
