...
def parse_arguments():
    ...
    parser.add_argument("--name", default="s-LAMB-atan", type=str, help="Name of the run.")
    ...
    parser.add_argument("--weight_decay", default=1e-5, type=float, help="Short sequence probability.")
