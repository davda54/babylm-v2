...
from adamw_msam import AdamWMSAM
...
def parse_arguments():
    ...
    parser.add_argument("--name", default="adamw_MSAM_5e-3", type=str, help="Name of the run.")
    ...
    parser.add_argument('--rho', default=0.1, type=float, help="Rho for the MSAM optimizer.")
