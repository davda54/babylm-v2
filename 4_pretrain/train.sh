...
SING_BIND="/pfs/lustrep1/scratch/project_465000144,/flash/project_465000144"

set -euo pipefail

CMD="/pfs/lustrep1/scratch/project_465000144/dasamuel/babylm-v2/4_pretrain/train_batch_schedule.py"
...
srun \
    ...
    -B "$SING_BIND" \
    "$CONTAINER" \
    /pfs/lustrep1/scratch/project_465000144/dasamuel/babylm-v2/4_pretrain/launch.sh \
    $CMD
