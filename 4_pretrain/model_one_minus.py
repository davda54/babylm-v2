...
class Attention(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask, relative_embedding):
        ...
        attention_probs = MaskedSoftmax.apply(attention_scores, attention_mask, -1)  # shape: [B, H, Q, K]
        attention_probs = attention_probs - torch.diag(torch.ones(query_len, key_len, device=hidden_states.device))
