...
from model_attentionglu_4 import Bert
...
def parse_arguments():
    ...
    parser.add_argument("--name", default="attentionGLU_l_skip", type=str, help="Name of the run.")
    parser.add_argument("--config_file", default="/pfs/lustrep1/scratch/project_465000144/dasamuel/babylm-v2/configs/xs_attentionglu.json", type=str, help="The BERT model config")
